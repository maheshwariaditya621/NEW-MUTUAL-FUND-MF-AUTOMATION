...
class ExtractorFactory:
    ...
    def get_extractor(amc_slug: str, year: int, month: int) -> Optional[BaseExtractor]:
        ...
        EXTRACTOR_MAP = {
            ...
            "helios": lambda: HeliosExtractorV1(),
            "invesco": lambda: InvescoExtractorV1(),
            "iti": lambda: ITIExtractorV1(),
            "jio_br": lambda: JioBRExtractorV1(),
            "jmfinancial": lambda: JMFinancialExtractorV1(),
            "mahindra": lambda: MahindraManulifeExtractorV1(),
            "taurus": lambda: TaurusExtractorV1(),
            "threesixtyone": lambda: ThreeSixtyOneExtractorV1(),
            "trust": lambda: TrustExtractorV1(),
            "unifi": lambda: UnifiExtractorV1(),
            "union": lambda: UnionExtractorV1(),
            "uti": lambda: UTIExtractorV1(),
            "shriram": lambda: ShriramExtractorV1(),
            "wealth_company": lambda: WealthExtractorV1(),
            "whiteoak": lambda: WhiteOakExtractorV1(),
            "zerodha": lambda: ZerodhaExtractorV1(),
        }
