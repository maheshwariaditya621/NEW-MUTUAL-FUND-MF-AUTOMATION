...
class BOIDownloader(BaseDownloader):
    ...
    def open_session(self):
        ...
        logger.info("Persistent Chrome session opened for BOI.")
    ...
    def close_session(self):
        ...
        logger.info("Persistent Chrome session closed for BOI.")
                    ...
                    if link.is_visible():
                        ...
                        if str(target_year) in link_text or not re.search(r'\d{4}', link_text):
                            ...
                            try:
                                ...
                                ext = os.path.splitext(suggested)[1] if suggested else ".pdf"
                                
                                final_filename = f"BOI_Portfolio_{month_name}_{target_year}{ext}"
