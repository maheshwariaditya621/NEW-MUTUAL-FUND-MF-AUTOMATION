# src/scheduler/uti_scheduler.py

import time
from datetime import datetime
from src.scheduler.uti_backfill import run_uti_backfill
...
def run_scheduler():
    logger.info("UTI Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("UTI", now.year, now.month, "Scheduler Failure", str(e)[:100])
