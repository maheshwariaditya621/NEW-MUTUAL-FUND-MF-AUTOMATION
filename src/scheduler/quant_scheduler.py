# src/scheduler/quant_scheduler.py

import time
from datetime import datetime
from src.scheduler.quant_backfill import run_quant_backfill
...
def run_scheduler():
    logger.info("Quant Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("QUANT", now.year, now.month, "Scheduler Failure", str(e)[:100])
