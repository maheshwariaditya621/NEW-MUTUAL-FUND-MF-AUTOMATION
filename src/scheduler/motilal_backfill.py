"""
Motilal Oswal Auto Backfill Module.
...
def run_backfill(
    ...
    logger.info("=" * 70)
    logger.info("Motilal Oswal BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Motilal Oswal Backfill")
