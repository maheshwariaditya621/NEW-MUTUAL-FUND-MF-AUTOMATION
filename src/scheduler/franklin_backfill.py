"""
Franklin Templeton Auto Backfill Module.
...
def run_backfill(
    ...
    """
    Run Franklin Templeton backfill.
    ...
    logger.info("=" * 70)
    logger.info("Franklin Templeton BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Franklin Templeton Backfill")
