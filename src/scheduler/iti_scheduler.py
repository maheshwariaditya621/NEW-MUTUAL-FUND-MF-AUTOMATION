# src/scheduler/iti_scheduler.py

import time
from datetime import datetime
from src.scheduler.iti_backfill import run_iti_backfill
...
def run_scheduler():
    logger.info("ITI Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("ITI", now.year, now.month, "Scheduler Failure", str(e)[:100])
