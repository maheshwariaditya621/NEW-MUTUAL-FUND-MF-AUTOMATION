# src/scheduler/motilal_scheduler.py

import time
from datetime import datetime
from src.scheduler.motilal_backfill import run_motilal_backfill
...
def run_scheduler():
    logger.info("Motilal Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("MOTILAL", now.year, now.month, "Scheduler Failure", str(e)[:100])
