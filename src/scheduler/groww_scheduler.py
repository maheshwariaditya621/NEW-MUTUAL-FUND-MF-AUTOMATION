# src/scheduler/groww_scheduler.py

import time
from datetime import datetime
from src.scheduler.groww_backfill import run_groww_backfill
...
def run_scheduler():
    logger.info("Groww Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("GROWW", now.year, now.month, "Scheduler Failure", str(e)[:100])
