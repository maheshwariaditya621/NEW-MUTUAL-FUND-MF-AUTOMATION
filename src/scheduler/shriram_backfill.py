"""
Shriram Mutual Fund Auto Backfill Module.
...
def run_backfill(
    ...
    logger.info("=" * 70)
    logger.info("SHRIRAM BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Shriram Mutual Fund Backfill")
