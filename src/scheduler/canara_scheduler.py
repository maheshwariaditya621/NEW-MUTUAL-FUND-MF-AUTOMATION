# src/scheduler/canara_scheduler.py

import time
from datetime import datetime
from src.scheduler.canara_backfill import run_canara_backfill
...
def run_scheduler():
    logger.info("Canara Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("CANARA", now.year, now.month, "Scheduler Failure", str(e)[:100])
