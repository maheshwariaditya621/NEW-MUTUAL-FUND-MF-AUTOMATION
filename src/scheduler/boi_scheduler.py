# src/scheduler/boi_scheduler.py

import time
from datetime import datetime
from src.scheduler.boi_backfill import run_boi_backfill
...
def run_scheduler():
    logger.info("BOI Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("BOI", now.year, now.month, "Scheduler Failure", str(e)[:100])
