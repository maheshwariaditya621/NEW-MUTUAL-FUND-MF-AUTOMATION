# src/scheduler/baroda_scheduler.py

import time
from datetime import datetime
from src.scheduler.baroda_backfill import run_baroda_backfill
...
def run_scheduler():
    logger.info("Baroda Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("BARODA", now.year, now.month, "Scheduler Failure", str(e)[:100])
