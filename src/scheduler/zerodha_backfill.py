"""
Zerodha Mutual Fund Auto Backfill Module.
...
def run_backfill(
    ...
    """
    Run Zerodha backfill.
    """
    start_time = time.time()

    logger.info("=" * 70)
    logger.info("ZERODHA BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Zerodha Mutual Fund Backfill")
