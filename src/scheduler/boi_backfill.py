"""
Bank of India Auto Backfill Module.
...
def run_backfill(
    ...
    logger.info("=" * 70)
    logger.info("Bank of India BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Bank of India Backfill")
