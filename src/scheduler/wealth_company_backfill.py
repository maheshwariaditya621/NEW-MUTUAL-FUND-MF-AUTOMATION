# src/scheduler/wealth_company_backfill.py
...
def is_month_complete(year: int, month: int) -> bool:
    ...
    folder_path = Path(f"data/raw/wealth_company/{year}_{month:02d}")
    success_marker = folder_path / "_SUCCESS.json"
    return success_marker.exists()


def run_wealth_company_backfill(
...
if __name__ == "__main__":
    ...
    run_wealth_company_backfill(args.start_year, args.start_month, args.end_year, args.end_month)
