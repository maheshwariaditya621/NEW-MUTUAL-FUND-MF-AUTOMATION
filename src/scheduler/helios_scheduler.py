# src/scheduler/helios_scheduler.py

import time
from datetime import datetime
from src.scheduler.helios_backfill import run_helios_backfill
...
def run_scheduler():
    logger.info("Helios Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("HELIOS", now.year, now.month, "Scheduler Failure", str(e)[:100])
