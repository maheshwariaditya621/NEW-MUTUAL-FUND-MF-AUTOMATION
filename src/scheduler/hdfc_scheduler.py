"""
HDFC Scheduler Module.

Runs HDFC backfill in TWO STAGES at fixed times:
- 07:00 AM
- 03:00 PM (15:00)
- 11:45 PM (23:45)
...
def run_two_stage_backfill() -> dict:
    ...
    if has_scheduled_range_config():
        ...
        try:
            stage1_result = run_hdfc_backfill(
    ...
    try:
        stage2_result = run_hdfc_backfill()  # No arguments = auto mode
...
def run_scheduler():
    ...
    """
    logger.info("=" * 70)
    logger.info("HDFC TWO-STAGE SCHEDULER STARTED")
    logger.info("=" * 70)
