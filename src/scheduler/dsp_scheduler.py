# src/scheduler/dsp_scheduler.py

import time
from datetime import datetime
from src.scheduler.dsp_backfill import run_dsp_backfill
...
def run_scheduler():
    logger.info("DSP Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("DSP", now.year, now.month, "Scheduler Failure", str(e)[:100])
