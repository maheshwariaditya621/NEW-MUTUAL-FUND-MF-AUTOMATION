# src/scheduler/sbi_scheduler.py

import time
from datetime import datetime
from src.scheduler.sbi_backfill import run_sbi_backfill
...
def run_scheduler():
    logger.info("SBI Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("SBI", now.year, now.month, "Scheduler Failure", str(e)[:100])
