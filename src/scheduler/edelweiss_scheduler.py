# src/scheduler/edelweiss_scheduler.py

import time
from datetime import datetime
from src.scheduler.edelweiss_backfill import run_edelweiss_backfill
...
def run_scheduler():
    logger.info("Edelweiss Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("EDELWEISS", now.year, now.month, "Scheduler Failure", str(e)[:100])
