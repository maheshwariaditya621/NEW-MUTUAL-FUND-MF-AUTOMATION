# src/scheduler/choice_scheduler.py

import time
from datetime import datetime
from src.scheduler.choice_backfill import run_choice_backfill
...
def run_scheduler():
    logger.info("Choice Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("CHOICE", now.year, now.month, "Scheduler Failure", str(e)[:100])
