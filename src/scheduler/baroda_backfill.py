"""
Baroda BNP Paribas Auto Backfill Module.
...
def run_backfill(
    ...
    """
    Run Baroda BNP Paribas backfill.
    ...
    logger.info("=" * 70)
    logger.info("Baroda BNP Paribas BACKFILL STARTED")
    if DRY_RUN:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Baroda BNP Paribas Backfill")
