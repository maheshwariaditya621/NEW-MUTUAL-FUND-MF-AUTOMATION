# src/scheduler/tata_scheduler.py

import time
from datetime import datetime
from src.scheduler.tata_backfill import run_tata_backfill
...
def run_scheduler():
    logger.info("Tata Scheduler Service Started")
    ...
    while True:
        ...
        if current_time in SCHEDULE_TIMES:
            ...
            try:
                ...
                get_notifier().notify_error("TATA", now.year, now.month, "Scheduler Failure", str(e)[:100])
