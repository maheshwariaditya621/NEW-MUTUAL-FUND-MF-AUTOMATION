-- ============================================================
-- MIGRATION 001: CREATE SCHEMA v1.0
-- ============================================================
...
--
-- This migration creates the complete schema v1.0 including:
...
--
-- IMPORTANT: This migration should be run ONLY ONCE on a fresh database.
-- Running it again will cause errors (tables already exist).
-- ============================================================
...
-- Success message
SELECT '✅ Schema v1.0 applied successfully!' AS status;